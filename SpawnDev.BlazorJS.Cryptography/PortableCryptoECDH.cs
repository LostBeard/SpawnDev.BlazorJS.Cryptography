...
namespace SpawnDev.BlazorJS.Cryptography
{
    public partial class PortableCrypto
    {
        ...
        public async Task<PortableECDHKey> GenerateECDHKey(string namedCurve = NamedCurve.P521, bool extractable = true)
        {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public async Task<PortableECDHKey> ImportECDHKey(byte[] publicKeySpki, string namedCurve = NamedCurve.P521, bool extractable = true)
        {
            if (OperatingSystem.IsBrowser())
            {
        ...
        /// <returns></returns>
        /// <exception cref="NotImplementedException"></exception>
        public async Task<PortableECDHKey> ImportECDHKey(byte[] publicKeySpki, byte[] privateKeyPkcs8, string namedCurve = NamedCurve.P521, bool extractable = true)
        {
            if (OperatingSystem.IsBrowser())
            {
                var keyUsages = new string[] { "deriveBits", "deriveKey" };
